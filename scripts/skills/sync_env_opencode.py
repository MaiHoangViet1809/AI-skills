#!/usr/bin/env python3
"""Sync AISkills skills into OpenCode-specific destinations."""
...
def opencode_skill_root(scope: str | None, target_project: str | None, target_root: str | None) -> Path:
    ...
    if scope == "repo":
        ...
        return normalized_path(target_project) / ".opencode" / "skills"
    if scope == "user":
