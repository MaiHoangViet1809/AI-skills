...
- **Location**: `plan_todo/SOW_task_router_flow_skill.md`, thư mục skill global mới dưới Codex skills home, các file skill liên quan gồm `SKILL.md` và `references/scope-of-work.md`, và cập nhật tối thiểu vào `AGENTS.md` nếu cần để chuyển hướng sang skill.
...
- **plan**: `plan_todo/SOW_task_router_flow_skill.md`
- **Cautions / Risks**:
